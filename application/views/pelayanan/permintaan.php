            ...
            <main class="content p-4 pb-0">
                <div class="container-fluid p-0">
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <a href="<?= base_url("pelayanan/permintaan/$id_pelayanan"); ?>" class="me-1 btn btn-primary active">Permintaan Darah</a>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($data_result as $item) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php $params = "[]"; ?>
                                                        <a href="<?= base_url("pelayanan/crossmatch/$item->id_permintaan"); ?>" class="btn btn-sm btn-outline-primary">
                                                            <i class="bi bi-clipboard-plus" data-bs-title="Detail data pasien"></i> CrossMatch
                                                        </a>
                                                    </td>
                                                </tr>
                                                <?php $no++ ?>
