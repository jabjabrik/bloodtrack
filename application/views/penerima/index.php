...
<body>
                                ...
                                <div class="card-body">
                                    <table id="datatables" class="table table-striped table-bordered text-capitalize" style="white-space: nowrap; font-size: 1em;">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th class="no-sort">Kode Penerima</th>
                                                <th>Nama Penerima</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($data_result as $item) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php $params = "[`$item->id_penerima`,`$item->kode_penerima`, `$item->nama_penerima`]"; ?>
                                                        <!-- BTN GROUP TABLE -->
                                                        <?php $this->view('components/btn_group_table', ['id' => $item->id_penerima, 'params' => $params]); ?>
                                                        <!-- End BTN GROUP TABLE -->
                                                    </td>
                                                </tr>
                                                <?php $no++ ?>
            ...
            <div class="modal-content">
                ...
                <form method="POST" autocomplete="off" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="row g-3">
                            <input name="id_penerima" id="id_penerima" hidden>
                            <div class="form-group col-12">
                                <label for="kode_penerima" class="form-label">Kode Penerima</label>
                                <input type="text" name="kode_penerima" id="kode_penerima" class="form-control" readonly>
                            </div>
                            <div class="form-group col-12">
    ...
    <!-- Script Form -->
    <?php $fields = ['id_penerima', 'kode_penerima', 'nama_penerima']; ?>
