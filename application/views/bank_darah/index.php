            ...
            <main class="content p-4 pb-0">
                <div class="container-fluid p-0">
                    ...
                    <div class="btn-group btn-group-sm">
                        <a href="<?= base_url('bankdarah'); ?>" class="me-1 btn btn-primary active" aria-current="page">Stok Darah</a>
                        <a href="<?= base_url('bankdarah/kadaluarsa'); ?>" class="me-1 btn btn-primary">Darah Kadaluarsa</a>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                    ...
                                    <table id="datatables" class="table table-striped table-bordered text-capitalize" style="white-space: nowrap; font-size: 1em;">
                                        <thead class="text-center">
                                            <tr>
                                                ...
                                                <th colspan="4" style="vertical-align: middle" class="no-sort">Stok</th>
